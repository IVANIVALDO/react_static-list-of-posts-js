...
expedita consequatur consequatur dolores quia eos et placeat`}],zc=({user:e})=>O.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}),Nc=({comment:e})=>O.jsxs("div",{className:"CommentInfo",children:[O.jsxs("div",{className:"CommentInfo__title",children:[O.jsx("strong",{className:"CommentInfo__name",children:e.name})," by ",O.jsx("a",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:e.email})]}),O.jsx("div",{className:"CommentInfo__body",children:e.body})]}),Pc=({comments:e})=>O.jsx("div",{className:"CommentList",children:e.map(t=>O.jsx(Nc,{comment:t},t.id))}),Lc=({post:e})=>{const{user:t,comments:i,title:n,body:a}=e;return O.jsxs("div",{className:"PostInfo",children:[O.jsxs("div",{className:"PostInfo__header",children:[O.jsx("h3",{className:"PostInfo__title",children:n}),O.jsxs("p",{children:[" Posted by ",O.jsx(zc,{user:t})]})]}),O.jsx("p",{className:"PostInfo__body",children:a}),O.jsx("hr",{}),i.length===0?O.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"}):O.jsx(Pc,{comments:i})]})},Tc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Mc=[{postId:1,id:1,name:"id labore ex et quam laborum",email:"Eliseo@gardner.biz",body:`laudantium enim quasi est quidem magnam voluptate ipsam eos
...
aut aut aut maxime quia temporibus ut omnis`}],Rc=({posts:e})=>{const t=e.map(i=>({...i,user:Tc.find(n=>n.id===i.userId),comments:Mc.filter(n=>n.postId===i.id)}));return O.jsx("div",{className:"PostList",children:t.map(i=>O.jsx(Lc,{post:i},i.id))})},Dc=()=>O.jsxs("section",{className:"App",children:[O.jsx("h1",{className:"App__title",children:"Static list of posts"}),O.jsx(Rc,{posts:Cc})]});em(document.getElementById("root")).render(O.jsx(Dc,{}));
