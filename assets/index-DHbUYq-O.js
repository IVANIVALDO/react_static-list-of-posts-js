...
expedita consequatur consequatur dolores quia eos et placeat`}],zc=({user:e})=>R.jsxs("div",{className:"user-container",children:[R.jsx("p",{className:"UserInfo",children:e.name}),R.jsxs("a",{href:`mailto:${e.email}`,className:"UserEmail",children:["(",e.email,")"]})]}),Nc=({comment:e})=>R.jsxs("div",{className:"CommentInfo",children:[R.jsxs("div",{className:"CommentInfo__title",children:[R.jsx("strong",{className:"CommentInfo__name",children:e.name})," by ",R.jsx("a",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:e.email})]}),R.jsx("div",{className:"CommentInfo__body",children:e.body})]}),Pc=({comments:e})=>R.jsx("div",{className:"CommentList",children:e.map(t=>R.jsx(Nc,{comment:t},t.id))}),Lc=({post:e})=>{const{user:t,comments:i,title:n,body:a}=e;return R.jsxs("div",{className:"PostInfo",children:[R.jsxs("div",{className:"PostInfo__header",children:[R.jsx("h3",{className:"PostInfo__title",children:n}),R.jsxs("p",{children:[" Posted by ",R.jsx(zc,{user:t})]})]}),R.jsx("p",{className:"PostInfo__body",children:a}),R.jsx("hr",{}),i.length===0?R.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"}):R.jsx(Pc,{comments:i})]})},Tc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Mc=[{postId:1,id:1,name:"id labore ex et quam laborum",email:"Eliseo@gardner.biz",body:`laudantium enim quasi est quidem magnam voluptate ipsam eos
...
aut aut aut maxime quia temporibus ut omnis`}],Rc=({posts:e})=>{const t=e.map(i=>({...i,user:Tc.find(n=>n.id===i.userId),comments:Mc.filter(n=>n.postId===i.id)}));return R.jsx("div",{className:"PostList",children:t.map(i=>R.jsx(Lc,{post:i},i.id))})},Dc=()=>R.jsxs("section",{className:"App",children:[R.jsx("h1",{className:"App__title",children:"Static list of posts"}),R.jsx(Rc,{posts:Cc})]});em(document.getElementById("root")).render(R.jsx(Dc,{}));
